...
export default function Page() {
  ...
  const headerY = useTransform(scrollYProgress, [0, 1, 1], [0, 0, -100]);
  ...
  return (
    <div className="om-oss-page">
      ...
      <div className="sec-header">
        ...
        <AnimatedParagraph>
          <h1>
            ...
            løsninger ved hjelp av{" "}
            <span>
              <ColorfulText text="kreativitet" />
            </span>
            .
          </h1>
        </AnimatedParagraph>
        ...
        <div className="us">
          ...
          <div className="us-text">
            <div className="us-text-header">
              <p>Marcus Bugge</p>
              <p className="us-text-p">( Eier, designer, utvikler )</p>
            </div>

            <div className="linked-in-logo">
              <Image src="/react.png" alt="linkedin" width={50} height={50} />
            </div>
          </div>
        </div>
        <div className="us">
      ...
      <div ref={containerRef}>
        <motion.div
          className="sec-header sticky-header"
          style={{
            y: headerY,
            position: "sticky",
            top: 0,
          ...
          <div className="expertise-container">
            <motion.div className="expertise-grid" style={{ x }}>
              <div className="expertise-item">
                <h3>5+</h3>
                <p>Års erfaring med å transformere bedrifter</p>
              </div>
              <div className="expertise-item">
                <h3>60+</h3>
